        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <select id="statusFilter" class="form-control">
                    ...
                    <option value="issued" <?= $statusFilter === 'issued' ? 'selected' : '' ?>>Đã phát hành vé</option>
                    <option value="used" <?= $statusFilter === 'used' ? 'selected' : '' ?>>Đã sử dụng</option>
...
function loadBookings(page) {
    ...
    $.ajax({
        ...
        dataType: 'json', // Đảm bảo jQuery parse phản hồi thành JSON
