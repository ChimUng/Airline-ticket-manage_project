...
if (isset($data['action'])) {
    switch ($data['action']) {
        ...
        case "add":
            ...
            $sql = "INSERT INTO passengers (booking_id, full_name, phone, birth_date, gender, passport_number, ticket_type) VALUES (?, ?, ?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("sssssss", $booking_id, $full_name, $phone, $birth_date, $gender, $passport_number, $ticket_type);
        ...
        case "update":
            ...
            $sql = "UPDATE passengers SET booking_id = ?, full_name = ?, phone = ?, birth_date = ?, gender = ?, passport_number = ?, ticket_type = ? WHERE passenger_id = ?";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("sssssssi", $booking_id, $full_name, $phone, $birth_date, $gender, $passport_number, $ticket_type, $passenger_id);
