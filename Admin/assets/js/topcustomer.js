        ...
        let html = `
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <p><strong>Tổng tiền:</strong> ${parseFloat(data.order.price).toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</p>
                    <p><strong>Phương thức thanh toán:</strong> ${data.order.payment_method}</p>
                    <p><strong>Trạng thái thanh toán:</strong> ${data.order.payment_status}</p>
                    <p><strong>Ngày thanh toán:</strong> ${data.order.payment_date ? formatDateTime(data.order.payment_date) : 'Chưa thanh toán'}</p>
                </div>
                <div class="col-md-6">
