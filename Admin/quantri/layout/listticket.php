        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <select id="ticketTypeFilter" class="form-control">
                    ...
                    <option value="Người lớn" <?= $ticketTypeFilter === 'Người lớn' ? 'selected' : '' ?>>Người lớn</option>
                    <option value="Trẻ em" <?= $ticketTypeFilter === 'Trẻ em' ? 'selected' : '' ?>>Trẻ em</option>
                    <option value="Sơ sinh" <?= $ticketTypeFilter === 'Sơ sinh' ? 'selected' : '' ?>>Sơ sinh</option>
                </select>
            </div>
            <div class="col-md-4">
